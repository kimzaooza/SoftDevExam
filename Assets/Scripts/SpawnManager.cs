...
public class SpawnManager : NetworkBehaviour
{
    ...
    public void SpawnNotPlayerPrefabsServerRpc(int Prefabindex, Vector2 position, ServerRpcParams serverRpcParams = default)
    {
    ...
    [ServerRpc(RequireOwnership = true)]
    public void DespawnGhostServerRpc(ServerRpcParams serverRpcParams = default)
    {
        GameObject gameObject = GameObject.FindGameObjectWithTag("Ghost");
        Destroy(gameObject);
    }
}
